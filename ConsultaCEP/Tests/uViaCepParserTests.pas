...
type
  TestTViaCepParser = class(TTestCase)
  private
...
procedure TestTViaCepParser.SetUp;
begin
  Service := TViaCepService.Create;
end;

procedure TestTViaCepParser.TearDown;
begin
  Service.Free;
end;

procedure TestTViaCepParser.TestParseAddressFromJSON;
var
  Addr: TAddress;
  JSON: string;
begin
...
procedure TestTViaCepParser.TestParseAddressFromXML;
var
  Addr: TAddress;
  XML: string;
begin
...
initialization
  RegisterTest(TestTViaCepParser.Suite);
